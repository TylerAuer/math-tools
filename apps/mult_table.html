...
<head>
  ...
  <title>Playing with the Multiplication Table</title>
...
<body>
  <div class="container">
    ...
    <!--  Title  -->
    <div class="col-xs-12">
      <p class="title-text text-center">Multiplication Table</p>
    ...
    <div id="btn-area" class="btn-bank" class="col-xs-12 text-center">
      <div id="control-btns" class="text-center">
  ...
  <script src="../scripts/mult-table.js"></script>
</body>
